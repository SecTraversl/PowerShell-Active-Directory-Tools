...
.EXAMPLE
  ...
  DistinguishedName : CN=IT Help Desk Shared Mailbox Users,OU=Security,OU=Groups,DC=subd,DC=MyDomain,DC=com
  Mail              : ITHelpDeskShrdMBXUsers@MyDomain.com
  Name              : IT Help Desk Shared Mailbox Users
  ObjectClass       : group
  ObjectGUID        : fa6c11c4-5143-2594-a7e0-f595cfe8b27c
  objectSid         : S-1-5-52-406248488-568713991-4301410127-23276
  SamAccountName    : IT Help Desk Shared Mailbox Users

  DistinguishedName : CN=IT Help Desk,OU=SharedMB,OU=Resources,DC=subd,DC=MyDomain,DC=com
  Mail              : ITHelpDesk@MyDomain.com
  Name              : IT Help Desk
  ObjectClass       : user
  ObjectGUID        : 662cd982-2593-1957-aa8f-53e4a066201d
  objectSid         : S-1-5-54-296445283-485954434-3440012693-92142
