<#
.SYNOPSIS
  The "Get-ADAccountsWithDifferentEnabledValues" function identifies a user with multiple accounts within a domain where one of those accounts is disabled and the other is enabled (possibly revealing accounts that could be removed from Active Directory).
...
.EXAMPLE
  ...
  ------------    ------------------- -------------   --------------------
  c-dagendesh.wao               False p-dagendesh.wao                 True
